...
import { apiGenSchema } from "@/lib/validation/ai/apiGen/apiGenSchema";
import { apiGenerate } from "@/service/ai/apiGen/apiGen";
...
function AIApiGenContainer({}: AIApiGenContainerProps) {
  ...
  return (
    <>
      ...
      >
        <div className="m-auto flex h-full w-full md:items-center lg:w-1/2">
          <CodeEditor
            height="40rem"
            readOnly={true}
